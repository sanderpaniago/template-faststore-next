...
export type ProductSummary_ProductFragment = { slug: string, sku: string, name: string, gtin: string, id: string, brand: { name: string, brandName: string }, isVariantOf: { productGroupID: string, name: string }, image: Array<{ url: string, alternateName: string }>, offers: { lowPrice: number, offers: Array<{ price: number, listPrice: number, quantity: number, seller: { identifier: string } }> } };
...
export type ValidateCartMutationMutation = { validateCart: { order: { orderNumber: string, acceptedOffer: Array<{ quantity: number, price: number, listPrice: number, seller: { identifier: string }, itemOffered: { sku: string, name: string, image: Array<{ url: string, alternateName: string }> } }> }, messages: Array<{ text: string, status: StoreStatus }> } | null };
...
export type BrowserProductQueryQuery = { product: { sku: string, name: string, gtin: string, id: string, isVariantOf: { productGroupID: string, name: string }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { offers: Array<{ price: number, listPrice: number, seller: { identifier: string } }> } } };
